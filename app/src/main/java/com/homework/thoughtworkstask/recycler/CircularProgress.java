...
public class CircularProgress extends View {
    ...
    //彩虹的颜色
//    private int[] mColors = {0xE3313300,0xE3313300,0xFFFFFF00,0xFF00FF00,0xFF00FFFF,0xFF0000FF,0xFF8B00FF};
    private int[] mColors = {getResources().getColor(R.color.theme_blue), getResources().getColor(R.color.theme_blue)};
    //        private int[] mColors = {0xE33133,0xE33133};
    /*
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgress_borderWidth2,
